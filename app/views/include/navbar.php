                    ...
                    <div class="topnav" id="myTopnav">
                        <div class="links">
                            <ul>
                                ...
                                <li class="vertical_line"> <a href="/index.php"><i class="fa  fa-home" id="icon"></i>الريئسية</a></li> 
                        ...
                        <div class="search">
                            <div class="logo">
                                <a href=""><img src="app/views/assets/img/logo.png" alt=""></a>
                            </div>
                        
                            <button>البحث<i class="fa  fa-search" id="icon"></i></button>
                            <a href="cart"> <i class="fa fa-cart-plus" id="icon"></i></a>
                            <span id="result"></span>
